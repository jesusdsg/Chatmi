...
export default function ChatFooter({ socket, messages, setMessages }: any) {
  ...
  return (
    <div className="px-8 py-4 bg-dark-2 w-full rounded-b-sm border-t border-dark-3 min-h-20 h-full">
